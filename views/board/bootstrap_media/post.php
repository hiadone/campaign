...
<div class="board">
    ...
    <ul class="list-group">
        <li class="list-group-item">
            <div class="col-sm-2"> <strong>MD 코드</strong></div>
            <div class="list-group-item-text" style="min-height:20px;">
            <?php echo html_escape(element('post_md', element('post', $view))); ?>
            </div>
        </li>
    <?php if (element('extra_content', $view)) { ?>
            ...
            <?php foreach (element('extra_content', $view) as $key => $value) { ?>
                <li class="list-group-item">
                    ...
                    <div class="list-group-item-text" style="min-height:20px;"><?php echo nl2br(html_escape(element('output', $value))); ?>
                    <?php 
                    if(element('field_name', $value)==='disable_hours') echo '<small class="pl10 bold">(단위 : 시간)</small>';  
                    if(element('field_name', $value)==='execute_time') echo '<small class="pl10 bold">(단위 : 초)</small>';
                    ?>
                    </div>
            ...
            <?php } ?>
                <!-- <li class="list-group-item">
                    <div class="col-sm-2"> <strong>JS 코드</strong></div>
                    <div class="list-group-item-text" style="min-height:20px;">
                    <?php echo urldecode(element('post_js', element('post', $view))); ?>
                    </div>
                </li> -->
    <?php } ?>
    </ul>
    <div class="contents-view hide">
